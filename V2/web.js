...
makeModel('aqua', 0, 0, 0, 1800.0, 900.5, 1000.0, 0, 0, 0, 'aqua.data', 0);
...
makeModel('fish', 5, 0, 10, 1, 1, 1, 0, 0, 0, 'fish.data', 0);
...
for(var i=0;i<100;i++){
  makeModel(i, 1, -14, 10+i*10, 50, 5, 5, 0, 0, 0, 'Grass_01.data', 0);

}
for(var i=100;i<200;i++){
  makeModel(i, 60, -14, 10+(i-100)*10, 50, 5, 5, 0, 0, 0, 'Grass_01.data', 0);

}
for(var i=200;i<300;i++){
  makeModel(i, -50, -14, 10+(i-200)*10, 50, 5, 5, 0, 0, 0, 'Grass_01.data', 0);
